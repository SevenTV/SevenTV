...
impl ManagementServer {
	...
	pub async fn run_grpc(&self, addr: std::net::SocketAddr) -> Result<(), tonic::transport::Error> {
		let server = tonic::transport::Server::builder()
			.add_service(
				image_processor_proto::image_processor_server::ImageProcessorServer::new(self.clone())
...
impl image_processor_proto::image_processor_server::ImageProcessor for ManagementServer {
	#[tracing::instrument(skip_all)]
