...
<svelte:head>
	<title>Terms of Service - {$t("page_titles.suffix")}</title>
</svelte:head>
...
<div class="page">
	...
	<p>
		...
		7tv.app website and/or the 7TV browser extension operated by SEVENTV SARL (“us”, “we”, “our”).
		This website is operated by SEVENTV SARL. SEVENTV SARL offers this website, including all
	...
	<p>
		We will provide these services to you, which are subject to the conditions stated below. Every
		time you visit this website, use its services, or install the 7TV extension app, you accept the
		following conditions. We encourage you to read them carefully.
	</p>
	...
	<p>
		SEVENTV SARL may revise these Terms of Use for its Website at any time without prior notice. By
	...
	<p>
		...
		counter-notification with the account holder engaged in the allegedly infringing activity or for
		publication. If you are concerned about your information being forwarded, you may wish to use an
	...
	<p>
		...
		copyrighted works are covered by this Notification, you may provide a representative list of the
	...
	<p>
		...
		may have to address suspected infringement.
	</p>
	<h2>Terms of Sale</h2>
	<h2>Changes and amendments</h2>
	<p>
