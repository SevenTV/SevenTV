...
const fn currency_symbol(currency: stripe::Currency) -> (&'static str, &'static str) {
	match currency {
		...
		stripe::Currency::ARS => ("$", "Argentine Peso"),
		stripe::Currency::AUD => ("$", "Australian Dollar"),
		...
		stripe::Currency::FJD => ("$", "Fijian Dollar"),
		...
		stripe::Currency::GYD => ("$", "Guyanese Dollar"),
		...
		stripe::Currency::JMD => ("$", "Jamaican Dollar"),
		...
		stripe::Currency::KYD => ("$", "Cayman Islands Dollar"),
		...
		stripe::Currency::LRD => ("$", "Liberian Dollar"),
		...
		stripe::Currency::NZD => ("$", "New Zealand Dollar"),
		...
		stripe::Currency::TTD => ("$", "Trinidad and Tobago Dollar"),
		...
		stripe::Currency::UYU => ("$U", "Uruguayan Peso"),
		...
		stripe::Currency::XCD => ("$", "East Caribbean Dollar"),
