...
<section class="download" id="download">
	...
	<h2>
		Download
		<svg aria-hidden="true" class="star hide-on-mobile" width="65" height="65" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
	...
	.download {
        ...
        .weird-smiley {
            ...
            &::before {
                ...
                right: -20%;
                bottom: -20%;
                background: radial-gradient(circle at bottom, rgba(56, 0, 176, 0.83), rgba(0, 215, 244, 0.5));
                filter: blur(100px);
            }
        }
	}
