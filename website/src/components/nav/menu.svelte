<script lang="ts">
	...
	import { CaretRight, ChartLine, ChatDots, Code, Compass, Gear, GlobeHemisphereWest, House, IconContext, LockSimple, Moon, Note, PaintBrush, Question, SealCheck, SignOut, SmileySticker, Star } from "phosphor-svelte";
</script>
